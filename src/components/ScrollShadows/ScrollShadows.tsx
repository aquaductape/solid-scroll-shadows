...
> = (props) => {
  ...
  const getShadowContainerStyle = () => {
    ...
    return `position: absolute; z-index: 1; pointer-events: none; overflow: hidden; -webkit-transform: translate3d(0, 0, 0); transition: opacity 300ms; ${getPositionSize()}; ${getFlip()}; `;
  };
